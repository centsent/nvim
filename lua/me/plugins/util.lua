...
return {{opts = {direction = "float"}, keys = {{desc = "Toggle terminal", "<leader>tt", ":ToggleTerm<cr>"}, {desc = "Toggle lazygit terminal", "<leader>tg", _2_}}, "akinsho/toggleterm.nvim"}, {cmd = "StartupTime", config = _3_, "dstein64/vim-startuptime"}, {"nvim-lua/plenary.nvim"}, {event = {"CursorMoved"}, "wakatime/vim-wakatime"}}